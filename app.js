...
{
	vkBridge.send("VKWebAppCallAPIMethod", {"method":"secure.addAppEvent","request_id":"test","client_secret":"zz04gCxpDhjvE5y3nM6T","params":{"user_id":"138614847", "activity_id":"2","value":"666", "v":"5.131", "access_token":"fca010d3fca010d3fca010d34ffcdcb604ffca0fca010d39e31e8db22d9c0ad08e7457b"}})
	 .then(data => console.log(data.result))
	 .catch(error => console.log(error));
}
